...
export const authService = {
   ...
   * Update user profile
   */
  updateProfile: async (data: any): Promise<IApiResponse> => {
    if (USE_MOCK) {
    ...
    // For real API, use FormData if there's a file
    if (data.avatar) {
      ...
      return axiosClient.put(API_ENDPOINTS.AUTH.PROFILE, formData, {
        headers: {
