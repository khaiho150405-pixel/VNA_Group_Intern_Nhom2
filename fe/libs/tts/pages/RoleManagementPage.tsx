    ...
    <MainLayout>
      ...
      >
        ...
        <DialogContent sx={{ py: 3 }}>
          <Box sx={{ pt: 5 }}>
            ...
            <Grid size={{ xs: 12, sm: 4 }}>
              <FormControl fullWidth size="small">
                <InputLabel id="dialog-role-type-label">Phân loại vai trò</InputLabel>
                <Select
                  labelId="dialog-role-type-label"
                  label="Phân loại vai trò"
                  value={formValues.type}
                  onChange={(e) => handleInputChange('type', e.target.value)}
                  disabled={isEditMode && selectedRoleId === 4}
                >
                  <MenuItem value="SO">Cán bộ Sở</MenuItem>
                  <MenuItem value="DN">Doanh nghiệp</MenuItem>
                </Select>
              </FormControl>
            </Grid>
          </Grid>
          ...
          {/* Collapsible Permission Table with filters and pagination inside Dialog */}
